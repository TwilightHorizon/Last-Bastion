...
public class MarketControl : MonoBehaviour
{
    ...
    public void ButtonTwo()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerOneUpgrade["attackSpeed"];
    }
    ...
    public void ButtonThree()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerOneUpgrade["range"];
    }
    ...
    public void ButtonFour()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerOneUpgrade["cost"];
    }
    ...
    public void ButtonFive()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerTwoUpgrade["damage"];
    }
    ...
    public void ButtonSix()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerTwoUpgrade["range"];
    }
    ...
    public void ButtonSeven()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerTwoUpgrade["cost"];
    }
    ...
    public void ButtonEight()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerThreeUpgrade["slow"];
    }
    ...
    public void ButtonNine()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerThreeUpgrade["range"];
    }
    ...
    public void ButtonTen()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerThreeUpgrade["cost"];
    }
    ...
    public void ButtonEleven()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerFourUpgrade["buff"];
    }
    ...
    public void ButtonTwelve()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerFourUpgrade["range"];
    }
    ...
    public void ButtonThirteen()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerFourUpgrade["cost"];
    }
    ...
    public void ButtonFourteen()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerFiveUpgrade["earning"];
    }
    ...
    public void ButtonFifteen()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerFiveUpgrade["cost"];
    }
    ...
    public void ButtonSixteen()
    {
        ...
        BackendGameData.Instance.UserGameData.gold -= 20 * BackendGameUpgradeData.Instance.UserGameUpgradeData.towerSixUpgrade["damage"];
    }
